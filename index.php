...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> |Gleam's Shop Management System</title>
    ...
    <style>
        ...
        @media screen{
            body{
                background-image:url('./images/bread.jfif') !important;
...
<body>
    ...
    <div class="container py-1" id="page-container">
        <?php 
