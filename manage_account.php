...
<div class="">
    ...
    <div class='w-100 px-0'>
        <div class="card my-10 col-6 offset-md-3 ">
        <div class="card-body">
            ...
            <div class="col-12">
                <form action="" id="user-form">
                    ...
                    <div class="form-group">
                        <label for="fullname" class="control-label"><h6>Full Name</h6></label>
                    ...
                    <div class="form-group">
                        <label for="username" class="control-label"><h6>Username</h6></label>
                    ...
                    <div class="form-group">
                        <label for="password" class="control-label"><h6>New Password</h6></label>
                    ...
                    <div class="form-group">
                        <label for="old_password" class="control-label"><h6>Old Password</h6></label>
